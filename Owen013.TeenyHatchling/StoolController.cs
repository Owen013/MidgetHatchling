        ...
        public void OnSolarSystemLoaded()
        {
            ...
            switch (LoadManager.s_currentScene)
            {
                case OWScene.SolarSystem:
                    ...
                    PlaceObject(NewStool(), timberHearth, new Vector3(32.1602f, -38.3847f, 184.5434f), Quaternion.Euler(357.5007f, 184.827f, 148.018f)); // Village starting campsite
