...
{
    public static AssetBundle models;
    public static Material hearthTexture, nomaiTexture, quantumTexture, strangerTexture, dreamTexture, simTexture;
    ...
    public static void OnSceneLoaded(OWScene scene, OWScene loadScene)
    {
    ...
    private static GameObject NewStool(Material texture)
    {
        GameObject stool = GameObject.Instantiate(models.LoadAsset<GameObject>("SH_Stool"));
    ...
    private static GameObject NewStoolSocket()
    {
    ...
    private static void PlaceObject(GameObject gameObject, GameObject parent, Vector3 localPos, Quaternion localRot)
    {
        if (parent == null)
        {
    ...
    private static void PlaceObject(GameObject gameObject, GameObject parent, Vector3 localPos)
    {
        if (parent == null)
        {
            ModMain.Instance.WriteLine($"Cannot place {gameObject.name} because parent is null.");
    ...
    private static void AutoAlignObject(GameObject gameObject)
    {
        Vector3 up;
